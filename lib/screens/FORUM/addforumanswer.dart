...
final CollectionReference userCollection = Firestore.instance.collection('forum');

  Future updateUserData(String uid,int snapshot) async {
    return await userCollection.document(widget.indexNumber).collection('comments').document(snapshot.toString()).setData({
