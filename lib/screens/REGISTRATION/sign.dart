...
//text field state
            ...
            GestureDetector(
              onTap: () {
                ...
                Navigator.of(context)
                    .pushReplacement(Routes.createSlideRoute(LoginScaffold()));
              },
              child: Container(
          ...
          child: Column(
            children: <Widget>[
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    Expanded(child: _ageTextField()),
                    SizedBox(
                      width: 10,
                    ),
                    Expanded(flex: 2, child: _contactTextField())
                  ],
                ),
              ),
              SizedBox(height: 20),
  ...
  Widget _ageTextField() => Container(
        ...
        child: TextFormField(
          ...
          keyboardType: TextInputType.number,
          validator: (val) =>
              val.length > 3 || val.length < 1 || double.parse(val) < 14
                  ? 'Enter a valid Age'
                  : null,
          onChanged: (val) {
            setState(() {
  ...
  Widget _contactTextField() => Container(
        ...
        child: TextFormField(
          ...
          keyboardType: TextInputType.number,
          validator: (val) =>
              val.length != 11 ? 'Enter a valid Contact Number' : null,
          onChanged: (val) {
            setState(() {
              contact = val;
            });
  ...
  Widget _addButton(AuthProvider auth) => Container(
      ...
      child: InkWell(
          onTap: () async {
            if (_formKey.currentState.validate()) {
              ...
              print(password);
              auth
                  .register(email, password, name, age, usn, contact, course)
                  .then((value) {
                Scaffold.of(context)
