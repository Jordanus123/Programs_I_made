...
class _AccountState extends State<Account> {
              ...
              child: Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    SizedBox(height: 20,),
                    _label("USN: "),
                    _basicInfo("-"+snapshot.data["usn"]),
                    _label("Age: "),
                    _basicInfo("-"+snapshot.data["age"]),
                    _label("Contact Number: "),
                    _basicInfo("-"+snapshot.data["contact"]),
                    _label("Course: "),
                    _basicInfo("-"+snapshot.data["course"]),
                    _label("Email: "),
                    _basicInfo("-"+snapshot.data["email"]),
                    SizedBox(height: 20,),
                    Container(
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
  ...
  Widget _addButton(snapshot) => Row(
    children: <Widget>[
      Container(
